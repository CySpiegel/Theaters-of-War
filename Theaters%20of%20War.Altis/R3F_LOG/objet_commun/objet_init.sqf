...
if (_fonctionnalites select __can_be_moved_by_player && !((typeOf _objet) in ["plp_cts_RuggedCrateGrey", "21st_Insignia_Console", "21st_Mobile_Command_Console", "Box_NATO_Equip_F", "plp_ct_PlasticBoxRed", "B_supplyCrate_F", "21st_Cargo_Net", "21st_CrashTeleporter", "21st_FOB_Command_Console", "21st_Vehicle_Spawner","21st_VehicleAmmoCrate","C_IDAP_supplyCrate_F","plp_bo_MobileCoolerBlue_Use","Land_PaperBox_01_small_closed_brown_F","CargoNet_01_box_F","plp_ct_WeathCrateBigGreen","ARP_Objects_cardboardcratewater","ARP_Objects_boxmre","ARP_Objects_cardboardcratemre"])) then
{
	_objet addAction ["<t color = ""#FC1D00"">" + "Delete Object", {_thisBetterWork = _this select 0; deleteVehicle _thisBetterWork;}, false, 4, false, true, "", "!R3F_LOG_mutex_local_verrou && R3F_LOG_objet_addAction == _target && R3F_LOG_action_deplacer_objet_valide"];
};