...
force ace_advanced_fatigue_performanceFactor = 0.635243;
force ace_advanced_fatigue_recoveryFactor = 2.5;
force ace_advanced_fatigue_swayFactor = 0.7;
force ace_advanced_fatigue_terrainGradientFactor = 1.01279;
...
force ace_cookoff_probabilityCoef = 2.48523;
...
force ace_medical_blood_bloodLifetime = 480;
...
force ace_nightvision_effectScaling = 0.223892;
force ace_nightvision_fogScaling = 0.20879;
force ace_nightvision_noiseScaling = 0.193689;
...
force ace_pylons_timePerPylon = 3.36313;
...
force ace_quickmount_speed = 17.8571;
...
force acre_sys_core_terrainLoss = 0.346505;
force acre_sys_core_ts3ChannelName = "Operations Room 2";
...
force force lambs_danger_maxRevealValue = 0.912536;
...
force force PiR_bloodlosingKoef_on = false;
force force PiR_bloodlosingM_on = 390;
force force PiR_captive_on = true;
force force force PiR_civilian_on = false;
...
force force PiR_counthealM_on = 6;
force force PiR_counthealR_on = false;
force force PiR_crawl_on = 11;
force force PiR_crawlM_on = 36;
force force PiR_DamageAllow_on = false;
force force PiR_dragger_on = 60;
force force PiR_drop_on = 25;
force force PiR_dropM_on = 65;
force force force PiR_east_on = false;
force force PiR_effect_on = 5;
force force PiR_heal_on = false;
force force PiR_helmet_on = true;
force force PiR_IFAK_on = true;
force force force PiR_injuriAI_on = false;
force force force PiR_injuriplayer_on = false;
force force PiR_repeatheal_on = false;
force force force PiR_resistance_on = false;
